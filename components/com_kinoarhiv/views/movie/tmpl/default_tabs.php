...
<div class="tabs breadcrumb">
	...
	<a href="<?php echo JRoute::_('index.php?option=com_kinoarhiv&view=movie&tab=screenshots&id='.$this->item->id.'&Itemid='.$this->itemid); ?>" class="<?php echo ($this->tab == 'screenshots') ? ' current' : ''; ?>tab-screenshots"><?php echo JText::_('COM_KA_MOVIE_TAB_SCRSHOTS'); ?></a>
