...
<div class="tabs breadcrumb">
	...
	<?php if (($this->item->attribs->tab_movie_scr == '' && $this->params->get('tab_movie_scr') == 1) || $this->item->attribs->tab_movie_scr == 1): ?>
		<a href="<?php echo JRoute::_('index.php?option=com_kinoarhiv&view=movie&page=screenshots&id=' . $this->item->id . '&Itemid=' . $this->itemid); ?>" class="tab-screenshots<?php echo ($this->page == 'screenshots') ? ' current uk-active' : ''; ?>"><?php echo JText::_('COM_KA_MOVIE_TAB_SCREENSHOTS'); ?></a>
	<?php endif; ?>
	...
	<?php if (($this->item->attribs->tab_movie_snd == '' && $this->params->get('tab_movie_snd') == 1) || $this->item->attribs->tab_movie_snd == 1): ?>
		<a href="<?php echo JRoute::_('index.php?option=com_kinoarhiv&view=movie&page=soundtracks&id=' . $this->item->id . '&Itemid=' . $this->itemid); ?>" class="tab-sound<?php echo ($this->page == 'soundtracks') ? ' current uk-active' : ''; ?>"><?php echo JText::_('COM_KA_MOVIE_TAB_SOUNDTRACKS'); ?></a>
	<?php endif; ?>
</div>
<div class="clear"></div>
