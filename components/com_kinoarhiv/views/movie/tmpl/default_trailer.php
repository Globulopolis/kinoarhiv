...
$item_trailer = $this->item->trailer; ?>
	...
	<div class="ui-widget trailer">
		...
		<?php if ($item_trailer->embed_code != ''):
			...
			<div>
				<video controls preload="none" poster="<?php echo $item_trailer->path.$item_trailer->screenshot; ?>" width="<?php echo $item_trailer->player_width; ?>" height="<?php echo $item_trailer->player_height; ?>">
...
$item_movie = $this->item->movie; ?>
	...
	<div class="ui-widget trailer">
		...
		<?php if ($item_movie->embed_code != ''):
			...
			<div>
				<video controls preload="none" poster="<?php echo $item_movie->path.$item_movie->screenshot; ?>" width="<?php echo $item_movie->player_width; ?>" height="<?php echo $item_movie->player_height; ?>">
			...
			<?php endif; ?>
			<?php if (count($item_movie->files['video_links']) > 0 && $this->params->get('allow_movie_download') == 1): ?>
			<div class="video-links">
				<span class="title"><?php echo JText::_('COM_KA_DOWNLOAD_MOVIE_OTHER_FORMAT'); ?></span>
