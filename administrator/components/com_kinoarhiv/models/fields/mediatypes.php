...
class JFormFieldMediatypes extends JFormField
{
	...
	public function getInput($name = '', $size = '', $maxlength = '', $default = '', $class = '', $readonly = '', $disabled = '', $required = '', $multiple = '', $data_type = '', $data_allow_clear = '')
	{
		...
		if (isset($this->element['data-min-input']))
		{
			$data_min_input = ' data-min-input="' . (int) $this->element['data-min-input'] . '"';
		}
		elseif (!empty($data_min_input))
		{
			$data_min_input = ' data-min-input="' . (int) $data_min_input . '"';
		}
		else
		{
			$data_min_input = '';
		...
		return '<input type="hidden" name="' . $name . '" id="' . $id . '" value="' . $value . '" class="' . $class . '"' . $size . $disabled . $readonly . $maxlength . $required . $data_type . $data_allow_clear . $data_min_input . ' />';
	}
}
