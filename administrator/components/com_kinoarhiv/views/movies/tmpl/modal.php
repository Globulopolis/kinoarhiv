...
$function = $app->input->getCmd('function', 'jSelectMovie');
$listOrder = $this->escape($this->state->get('list.ordering'));
$listDirn = $this->escape($this->state->get('list.direction'));
?>
<form action="<?php echo JRoute::_('index.php?option=com_kinoarhiv&view=movies&layout=modal&tmpl=component&function=' . $function . '&' . JSession::getFormToken() . '=1'); ?>"
	...
	<table class="table table-striped table-condensed">
		...
		<tr>
			...
			<th width="5%" class="center nowrap center">
		...
		<?php foreach ($this->items as $i => $item) : ?>
			...
			<tr class="row<?php echo $i % 2; ?>">
				<td>
					<a href="javascript:void(0)" onclick="if (window.parent) window.parent.<?php echo $this->escape($function); ?>('<?php echo $item->id; ?>', '<?php echo $this->escape(addslashes($item->title)); ?>', '<?php echo $this->escape(0); ?>', null, '<?php echo $this->escape(ContentHelperRoute::getArticleRoute($item->id, 0, $item->language)); ?>', '<?php echo $this->escape($lang); ?>', null);">
