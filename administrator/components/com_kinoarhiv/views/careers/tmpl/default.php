		...
		<table class="table table-striped" id="articleList">
			...
			<?php else:
				...
				<tr class="row<?php echo $i % 2; ?>">
					...
					<td class="center hidden-phone">
						<a href="<?php echo JRoute::_('index.php?option=com_kinoarhiv&view=relations&task=careers&id='.$item->id); ?>" class="hasTooltip" title="<?php echo JText::_('COM_KA_TABLES_RELATIONS').': '.$this->escape($item->title); ?>"><img src="components/com_kinoarhiv/assets/images/icons/arrow_switch.png" border="0" /></a>
