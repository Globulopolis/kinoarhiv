...
class KinoarhivControllerAwards extends JControllerLegacy
{
	...
	public function save()
	{
		...
		$app->setUserState('com_kinoarhiv.awards.' . $user->id . '.edit_data', $validData);
	...
	public function cancel()
	{
		...
		JFactory::getApplication()->setUserState('com_kinoarhiv.awards.' . JFactory::getUser()->id . '.edit_data', null);
