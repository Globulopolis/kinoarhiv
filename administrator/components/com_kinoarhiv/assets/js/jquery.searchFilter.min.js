...
*/
jQuery.fn.searchFilter=function(e,E){return new function(c,e,t){this.$=c;this.add=function(a){null==a?c.find(".ui-add-last").click():c.find(".sf:eq("+a+") .ui-add").click();return this};this.del=function(a){null==a?c.find(".sf:last .ui-del").click():c.find(".sf:eq("+a+") .ui-del").click();return this};this.search=function(a){c.find(".ui-search").click();return this};this.reset=function(a){void 0===a&&(a=!1);c.find(".ui-reset").trigger("click",[a]);return this};this.close=function(){c.find(".ui-closer").click();
return this};if(null!=e){var y=function(){jQuery(this).toggleClass("ui-state-hover");return!1},z=function(a){jQuery(this).toggleClass("ui-state-active","mousedown"==a.type);return!1},h=function(a,b){return"<option value='"+a+"'>"+b+"</option>"},u=function(a,b,d){return"<select class='"+a+"'"+(d?" style='display:none;'":"")+">"+b+"</select>"},A=function(a,b){var d=c.find("tr.sf td.data "+a);null!=d[0]&&b(d)},B=function(a,b){var d=c.find("tr.sf td.data "+a);null!=d[0]&&jQuery.each(b,function(){null!=
this.data?d.bind(this.type,this.data,this.fn):d.bind(this.type,this.fn)})},f=jQuery.extend({},jQuery.fn.searchFilter.defaults,t),k=-1,g="";jQuery.each(f.groupOps,function(){g+=h(this.op,this.text)});g="<select name='groupOp'>"+g+"</select>";c.html("").addClass("ui-searchFilter").append("<div class='ui-widget-overlay' style='z-index: -1'>&#160;</div><table class='ui-widget-content ui-corner-all'><thead><tr><td colspan='5' class='ui-widget-header ui-corner-all' style='line-height: 18px;'><div class='ui-closer ui-state-default ui-corner-all ui-helper-clearfix' style='float: right;'><span class='ui-icon ui-icon-close'></span></div>"+
...
var v=c.find("tr.sf"),C=v.find("td.fields"),w=v.find("td.ops"),l=v.find("td.data"),m="";jQuery.each(f.operators,function(){m+=h(this.op,this.text)});m=u("default",m,!0);w.append(m);l.append("<input type='text' class='default' style='display:none;' />");var r="",x=!1,s=!1;jQuery.each(e,function(a){r+=h(this.itemval,this.text);if(null!=this.ops){x=!0;var b="";jQuery.each(this.ops,function(){b+=h(this.op,this.text)});b=u("field"+a,b,!0);w.append(b)}if(null!=this.dataUrl){a>k&&(k=a);s=!0;var d=this.dataEvents,
p=this.dataInit,D=this.buildSelect;jQuery.ajax(jQuery.extend({url:this.dataUrl,complete:function(b){b=null!=D?jQuery("<div />").append(D(b)):jQuery("<div />").append(b.responseText);b.find("select").addClass("field"+a).hide();l.append(b.html());p&&A(".field"+a,p);d&&B(".field"+a,d);a==k&&c.find("tr.sf td.fields select[name='field']").change()}},f.ajaxSelectOptions))}else if(null!=this.dataValues){s=!0;var q="";jQuery.each(this.dataValues,function(){q+=h(this.value,this.text)});q=u("field"+a,q,!0);
l.append(q)}else if(null!=this.dataEvents||null!=this.dataInit)s=!0,q="<input type='text' class='field"+a+"' />",l.append(q);null!=this.dataInit&&a!=k&&A(".field"+a,this.dataInit);null!=this.dataEvents&&a!=k&&B(".field"+a,this.dataEvents)});r="<select name='field'>"+r+"</select>";C.append(r);e=C.find("select[name='field']");x?e.change(function(a){var b=a.target.selectedIndex;a=jQuery(a.target).parents("tr.sf").find("td.ops");a.find("select").removeAttr("name").hide();b=a.find(".field"+b);null==b[0]&&
(b=a.find(".default"));b.attr("name","op").show();return!1}):w.find(".default").attr("name","op").show();s?e.change(function(a){var b=a.target.selectedIndex;a=jQuery(a.target).parents("tr.sf").find("td.data");a.find("select,input").removeClass("vdata").hide();b=a.find(".field"+b);null==b[0]&&(b=a.find(".default"));b.show().addClass("vdata");return!1}):l.find(".default").show().addClass("vdata");(x||s)&&e.change();c.find(".ui-state-default").hover(y,y).mousedown(z).mouseup(z);c.find(".ui-closer").click(function(a){f.onClose(jQuery(c.selector));
