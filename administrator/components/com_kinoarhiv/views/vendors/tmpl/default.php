			...
			<thead>
				<tr>
					...
					<th width="1%" style="min-width:55px" class="nowrap center">
						<?php echo JHtml::_('grid.sort', 'JSTATUS', 'v.state', $listDirn, $listOrder); ?>
					</th>
					<th>
						<?php echo JHtml::_('grid.sort', 'COM_KA_VENDORS_FIELD_TITLE', 'v.company_name', $listDirn, $listOrder); ?>
					</th>
					<th>
						<?php echo JHtml::_('grid.sort', 'COM_KA_VENDORS_FIELD_TITLE_INTL', 'v.company_name_intl', $listDirn, $listOrder); ?>
					</th>
