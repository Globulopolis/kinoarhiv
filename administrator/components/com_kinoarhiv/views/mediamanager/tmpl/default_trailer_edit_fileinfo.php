...
?>
<form action="<?php echo JRoute::_('index.php?option=com_kinoarhiv'); ?>" method="post" name="adminFormFile" autocomplete="off" id="fileinfo-item-form" class="form-validate">
