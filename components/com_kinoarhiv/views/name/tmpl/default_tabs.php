...
<div class="tabs breadcrumb">
	...
	<?php if (($this->item->attribs->tab_name_wallpp == '' && $this->params->get('tab_name_wallpp') == 1) || $this->item->attribs->tab_name_wallpp == 1): ?>
		<a href="<?php echo JRoute::_('index.php?option=com_kinoarhiv&view=name&page=wallpapers&id='.$this->item->id.'&Itemid='.$this->itemid); ?>" class="tab-wallpp<?php echo ($this->page == 'wallpapers') ? ' current uk-active' : '';?>"><?php echo JText::_('COM_KA_NAMES_TAB_WALLPP'); ?></a>
	<?php endif; ?>

	<?php if (($this->item->attribs->tab_name_photos == '' && $this->params->get('tab_name_photos') == 1) || $this->item->attribs->tab_name_photos == 1): ?>
		<a href="<?php echo JRoute::_('index.php?option=com_kinoarhiv&view=name&page=photos&id='.$this->item->id.'&Itemid='.$this->itemid); ?>" class="tab-photo<?php echo ($this->page == 'photos') ? ' current uk-active' : '';?>"><?php echo JText::_('COM_KA_NAMES_TAB_PHOTO'); ?></a>
	<?php endif; ?>
