...
<div class="uk-article ka-content">
	...
	<?php endif;
		...
		<br/>
		<div><?php echo ($this->params->get('search_names_enable') == 1 && $this->activeFilters->exists('filters.names')) ? JText::sprintf('COM_KA_SEARCH_KEYWORD_N_RESULTS', 0) : KAComponentHelper::showMsg(JText::_('COM_KA_NO_ITEMS')); ?></div>
	<?php endif; ?>
</div>
