		...
		<div>
			<?php if ($item_trailer->embed_code != ''):
				...
				<?php if (count($item_trailer->files['video']) > 0): ?>
					<div>
						<video controls preload="none" poster="<?php echo $item_trailer->screenshot; ?>" width="<?php echo $item_trailer->player_width; ?>" height="<?php echo $item_trailer->player_height; ?>">
		...
		<div>
			<?php if ($item_movie->embed_code != ''):
				...
				<?php if (count($item_movie->files['video']) > 0): ?>
					<div>
						<video controls preload="none" poster="<?php echo $item_movie->screenshot; ?>" width="<?php echo $item_movie->player_width; ?>" height="<?php echo $item_movie->player_height; ?>">
