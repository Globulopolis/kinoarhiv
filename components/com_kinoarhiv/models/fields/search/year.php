...
class JFormFieldYear extends JFormFieldList
{
	...
	protected function getInput()
	{
		...
		if ($this->element['data-range'] == 'true')
		{
			...
			$html[] = JHtml::_('select.genericlist', $years, $this->name . '[]', $attr, 'value', 'text', $this->value, $this->id . '_from');
			$html[] = '&nbsp;&nbsp;&nbsp;&nbsp;' . JText::_($this->element['labelto']) . '&nbsp;';
			$html[] = JHtml::_('select.genericlist', $years, $this->name . '[]', $attr, 'value', 'text', $this->value, $this->id . '_to');
		}
		else
		{
