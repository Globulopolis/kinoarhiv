...
<div class="reviews">
		...
		<script type="text/javascript">
			...
			jQuery(document).ready(function ($) {
				...
				$('#review-form').submit(function (e) {
					...
					/*if (editor.parse(editor.getValue()).length <
					<?php echo $this->params->get('reviews_length_min'); ?> || editor.parse(editor.getValue()).length >
					<?php echo $this->params->get('reviews_length_max'); ?>) {
					 showMsg($(this), '
					<?php echo JText::sprintf(JText::_('COM_KA_EDITOR_EMPTY'), $this->params->get('reviews_length_min'), $this->params->get('reviews_length_max')); ?>');
					 editor.enable();
	...
	<?php if ($this->item->attribs->allow_reviews == 1): ?>
				...
				<li class="e-btn hasTip font" title="<?php echo JText::_('COM_KA_EDITOR_FONT'); ?>">
					<div class="dropdown" data-uk-dropdown="{mode:'click'}">
						...
						<ul id="font-type-list" class="dropdown-menu uk-dropdown" role="menu" aria-labelledby="dLabel">
							<li data-wysihtml5-command="fontType" data-wysihtml5-command-value="arial" class="arial">
								Arial
							</li>
							<li data-wysihtml5-command="fontType" data-wysihtml5-command-value="courier-new" class="courier-new">
								Courier New
							</li>
							<li data-wysihtml5-command="fontType" data-wysihtml5-command-value="georgia" class="georgia">
								Georgia
							</li>
							<li data-wysihtml5-command="fontType" data-wysihtml5-command-value="helvetica-neue" class="helvetica-neue">
								Helvetica Neue
							</li>
							<li data-wysihtml5-command="fontType" data-wysihtml5-command-value="times-new-roman" class="times-new-roman">
								Times New Roman
							</li>
							<li data-wysihtml5-command="fontType" data-wysihtml5-command-value="verdana" class="verdana">
								Verdana
							</li>
						</ul>
					</div>
				...
				<li class="e-btn hasTip font-size" title="<?php echo JText::_('COM_KA_EDITOR_FONTSIZE'); ?>">
					<div class="dropdown" data-uk-dropdown="{mode:'click'}">
						...
						<ul id="font-size-list" class="dropdown-menu uk-dropdown" role="menu" aria-labelledby="dLabel">
							<li data-wysihtml5-command="fontSize" data-wysihtml5-command-value="8" class="size-8">8pt
							</li>
							<li data-wysihtml5-command="fontSize" data-wysihtml5-command-value="9" class="size-9">9pt
							</li>
							<li data-wysihtml5-command="fontSize" data-wysihtml5-command-value="10" class="size-10">
								10pt
							</li>
							<li data-wysihtml5-command="fontSize" data-wysihtml5-command-value="11" class="size-11">
								11pt
							</li>
							<li data-wysihtml5-command="fontSize" data-wysihtml5-command-value="12" class="size-12">
								12pt
							</li>
							<li data-wysihtml5-command="fontSize" data-wysihtml5-command-value="14" class="size-14">
								14pt
							</li>
							<li data-wysihtml5-command="fontSize" data-wysihtml5-command-value="16" class="size-16">
								16pt
							</li>
							<li data-wysihtml5-command="fontSize" data-wysihtml5-command-value="18" class="size-18">
								18pt
							</li>
							<li data-wysihtml5-command="fontSize" data-wysihtml5-command-value="20" class="size-20">
								20pt
							</li>
							<li data-wysihtml5-command="fontSize" data-wysihtml5-command-value="22" class="size-22">
								22pt
							</li>
							<li data-wysihtml5-command="fontSize" data-wysihtml5-command-value="24" class="size-24">
								24pt
							</li>
							<li data-wysihtml5-command="fontSize" data-wysihtml5-command-value="26" class="size-26">
								26pt
							</li>
							<li data-wysihtml5-command="fontSize" data-wysihtml5-command-value="28" class="size-28">
								28pt
							</li>
							<li data-wysihtml5-command="fontSize" data-wysihtml5-command-value="36" class="size-36">
								36pt
							</li>
							<li data-wysihtml5-command="fontSize" data-wysihtml5-command-value="48" class="size-48">
								48pt
							</li>
							<li data-wysihtml5-command="fontSize" data-wysihtml5-command-value="72" class="size-72">
								72pt
							</li>
						</ul>
					</div>
