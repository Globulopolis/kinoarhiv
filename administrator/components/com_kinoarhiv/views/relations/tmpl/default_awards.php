...
<script src="<?php echo JURI::base(); ?>components/com_kinoarhiv/assets/js/jquery.searchFilter.js" type="text/javascript"></script>
...
<script type="text/javascript">
	jQuery(document).ready(function($){
		...
		$('#list').jqGrid({
			...
			colModel:[
				{name:'award', index:'award', width:300, searchrules:{required:true}, sorttype:"text", searchoptions: {sopt: ['eq','bw','ew','cn']}},
				{name:'award_id', index:'award_id', width:70, searchrules:{required:true}, sorttype:"int", searchoptions: {sopt: ['eq','le','ge', 'in']}},
				{name:'<?php echo $colModel['item_title']; ?>', index:'<?php echo $colModel['item_title']; ?>', width:350, sorttype:"text", searchrules:{required:true}, searchoptions: {sopt: ['eq','bw','ew','cn']}},
				{name:'<?php echo $colModel['item_id']; ?>', index:'<?php echo $colModel['item_id']; ?>', width:70, sorttype:"int", searchrules:{required:true}, searchoptions: {sopt: ['eq','le','ge', 'in']}},
