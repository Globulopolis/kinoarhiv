		...
		$('.js-stools-btn-clear').parent().after(
			'<div class="btn-wrapper">' +
				'<button class="btn search-help" type="button"' +
						'onclick="Aurora.message([{text: \'<?php echo JText::_('COM_KA_NAMES_SEARCH_HELP'); ?>\'}], \'#system-message-container\', {replace: true});">' +
...
<div id="j-main-container">
	<form action="<?php echo JRoute::_('index.php?option=com_kinoarhiv&view=names'); ?>" method="post"
		  name="adminForm" id="adminForm" autocomplete="off">
		<?php echo JLayoutHelper::render('joomla.searchtools.default', array('view' => $this)); ?>
		<div class="clearfix"> </div>

		<table class="table table-striped sortable" id="articleList"
			   data-sort-url="index.php?option=com_kinoarhiv&task=saveOrder&items=names&tmpl=component&format=json">
			<thead>
				<tr>
