...
window.rangy=function(){function a(a,b){var c=typeof a[b];return c==l||!!(c==h&&a[b])||"unknown"==c}function c(a,b){return!!(typeof a[b]==h&&a[b])}function b(a,b){return typeof a[b]!=m}function d(a){return function(b,c){for(var d=c.length;d--;)if(!a(b,c[d]))return!1;return!0}}function e(a){return a&&r(a,q)&&w(a,C)}function f(a){window.alert("Rangy not supported in your browser. Reason: "+a);t.initialized=!0;t.supported=!1}function g(){if(!t.initialized){var b,d=!1,l=!1;a(document,"createRange")&&
(b=document.createRange(),r(b,u)&&w(b,p)&&(d=!0),b.detach());if((b=c(document,"body")?document.body:document.getElementsByTagName("body")[0])&&a(b,"createTextRange"))b=b.createTextRange(),e(b)&&(l=!0);!d&&!l&&f("Neither Range nor TextRange are implemented");t.initialized=!0;t.features={implementsDomRange:d,implementsTextRange:l};d=x.concat(y);l=0;for(b=d.length;l<b;++l)try{d[l](t)}catch(m){c(window,"console")&&a(window.console,"log")&&window.console.log("Init listener threw an exception. Continuing.",
m)}}}function k(a){this.name=a;this.supported=this.initialized=!1}var h="object",l="function",m="undefined",p="startContainer startOffset endContainer endOffset collapsed commonAncestorContainer START_TO_START START_TO_END END_TO_START END_TO_END".split(" "),u="setStart setStartBefore setStartAfter setEnd setEndBefore setEndAfter collapse selectNode selectNodeContents compareBoundaryPoints deleteContents extractContents cloneContents insertNode surroundContents cloneRange toString detach".split(" "),
C="boundingHeight boundingLeft boundingTop boundingWidth htmlText text".split(" "),q="collapse compareEndPoints duplicate getBookmark moveToBookmark moveToElementText parentElement pasteHTML select setEndPoint getBoundingClientRect".split(" "),r=d(a),s=d(c),w=d(b),t={version:"1.2.2",initialized:!1,supported:!0,util:{isHostMethod:a,isHostObject:c,isHostProperty:b,areHostMethods:r,areHostObjects:s,areHostProperties:w,isTextRange:e},features:{},modules:{},config:{alertOnWarn:!1,preferTextRange:!1}};
t.fail=f;t.warn=function(a){a="Rangy warning: "+a;t.config.alertOnWarn?window.alert(a):typeof window.console!=m&&typeof window.console.log!=m&&window.console.log(a)};({}).hasOwnProperty?t.util.extend=function(a,b){for(var c in b)b.hasOwnProperty(c)&&(a[c]=b[c])}:f("hasOwnProperty not supported");var y=[],x=[];t.init=g;t.addInitListener=function(a){t.initialized?a(t):y.push(a)};var A=[];t.addCreateMissingNativeApiListener=function(a){A.push(a)};t.createMissingNativeApi=function(a){a=a||window;g();
for(var b=0,c=A.length;b<c;++b)A[b](a)};k.prototype.fail=function(a){this.initialized=!0;this.supported=!1;throw Error("Module '"+this.name+"' failed to load: "+a);};k.prototype.warn=function(a){t.warn("Module "+this.name+": "+a)};k.prototype.createError=function(a){return Error("Error in Rangy "+this.name+" module: "+a)};t.createModule=function(a,b){var c=new k(a);t.modules[a]=c;x.push(function(a){b(a,c);c.initialized=!0;c.supported=!0})};t.requireModules=function(a){for(var b=0,c=a.length,d,e;b<
c;++b){e=a[b];d=t.modules[e];if(!d||!(d instanceof k))throw Error("Module '"+e+"' not found");if(!d.supported)throw Error("Module '"+e+"' not supported");}};var D=!1,s=function(a){D||(D=!0,t.initialized||g())};if(typeof window==m)f("No window found");else if(typeof document==m)f("No document found");else return a(document,"addEventListener")&&document.addEventListener("DOMContentLoaded",s,!1),a(window,"addEventListener")?window.addEventListener("load",s,!1):a(window,"attachEvent")?window.attachEvent("onload",
...
if(typeof a.ownerDocument!=u)return a.ownerDocument;if(typeof a.document!=u)return a.document;if(a.parentNode)return k(a.parentNode);throw Error("getDocument: no document found for node");}function h(a){return!a?"[No node]":f(a)?'"'+a.data+'"':1==a.nodeType?"<"+a.nodeName+(a.id?' id="'+a.id+'"':"")+">["+a.childNodes.length+"]":a.nodeName}function l(a){this._next=this.root=a}function m(a,b){this.node=a;this.offset=b}function p(a){this.code=this[a];this.codeName=a;this.message="DOMException: "+this.codeName}
var u="undefined",C=a.util;C.areHostMethods(document,["createDocumentFragment","createElement","createTextNode"])||c.fail("document missing a Node creation method");C.isHostMethod(document,"getElementsByTagName")||c.fail("document missing getElementsByTagName method");var q=document.createElement("div");C.areHostMethods(q,["insertBefore","appendChild","cloneNode"])||c.fail("Incomplete Element implementation");C.isHostProperty(q,"innerHTML")||c.fail("Element is missing innerHTML property");q=document.createTextNode("test");
...
null}};m.prototype={equals:function(a){return this.node===a.node&this.offset==a.offset},inspect:function(){return"[DomPosition("+h(this.node)+":"+this.offset+")]"}};p.prototype={INDEX_SIZE_ERR:1,HIERARCHY_REQUEST_ERR:3,WRONG_DOCUMENT_ERR:4,NO_MODIFICATION_ALLOWED_ERR:7,NOT_FOUND_ERR:8,NOT_SUPPORTED_ERR:9,INVALID_STATE_ERR:11};p.prototype.toString=function(){return this.message};a.dom={arrayContains:r,isHtmlNamespace:function(a){var b;return typeof a.namespaceURI==u||null===(b=a.namespaceURI)||"http://www.w3.org/1999/xhtml"==
...
throw Error("getIframeWindow: No Document object found for iframe element");},getBody:function(a){return C.isHostObject(a,"body")?a.body:a.getElementsByTagName("body")[0]},getRootContainer:function(a){for(var b;b=a.parentNode;)a=b;return a},comparePoints:function(a,c,l,m){var h;if(a==l)return c===m?0:c<m?-1:1;if(h=e(l,a,!0))return c<=b(h)?-1:1;if(h=e(a,l,!0))return b(h)<m?-1:1;c=d(a,l);a=a===c?c:e(a,c,!0);l=l===c?c:e(l,c,!0);if(a===l)throw Error("comparePoints got to case 4 and childA and childB are the same!");
for(c=c.firstChild;c;){if(c===a)return-1;if(c===l)return 1;c=c.nextSibling}throw Error("Should not be here!");},inspectNode:h,fragmentFromNodeChildren:function(a){for(var b=k(a).createDocumentFragment(),c;c=a.firstChild;)b.appendChild(c);return b},createIterator:function(a){return new l(a)},DomPosition:m};a.DOMException=p});
rangy.createModule("DomRange",function(a,c){function b(a,b){return 3!=a.nodeType&&(n.isAncestorOf(a,b.startContainer,!0)||n.isAncestorOf(a,b.endContainer,!0))}function d(a){return n.getDocument(a.startContainer)}function e(a,b,c){if(b=a._listeners[b])for(var d=0,e=b.length;d<e;++d)b[d].call(a,{target:a,args:c})}function f(a){return new I(a.parentNode,n.getNodeIndex(a))}function g(a){return new I(a.parentNode,n.getNodeIndex(a)+1)}function k(a,b,c){var d=11==a.nodeType?a.firstChild:a;n.isCharacterDataNode(b)?
c==b.length?n.insertAfter(a,b):b.parentNode.insertBefore(a,0==c?b:n.splitDataNode(b,c)):c>=b.childNodes.length?b.appendChild(a):b.insertBefore(a,b.childNodes[c]);return d}function h(a){for(var b,c,e=d(a.range).createDocumentFragment();c=a.next();){b=a.isPartiallySelectedSubtree();c=c.cloneNode(!b);b&&(b=a.getSubtreeIterator(),c.appendChild(h(b)),b.detach(!0));if(10==c.nodeType)throw new E("HIERARCHY_REQUEST_ERR");e.appendChild(c)}return e}function l(a,b,c){var d,e;for(c=c||{stop:!1};d=a.next();)if(a.isPartiallySelectedSubtree())if(!1===
...
c.appendChild(b)}return c}function u(a,b,c){var d=!(!b||!b.length),e,m=!!c;d&&(e=RegExp("^("+b.join("|")+")$"));var h=[];l(new q(a,!1),function(a){(!d||e.test(a.nodeType))&&(!m||c(a))&&h.push(a)});return h}function C(a){return"["+("undefined"==typeof a.getName?"Range":a.getName())+"("+n.inspectNode(a.startContainer)+":"+a.startOffset+", "+n.inspectNode(a.endContainer)+":"+a.endOffset+")]"}function q(a,b){this.range=a;this.clonePartiallySelectedTextNodes=b;if(!a.collapsed){this.sc=a.startContainer;
...
this[a];this.codeName=a;this.message="RangeException: "+this.codeName}function s(a,b,c){this.nodes=u(a,b,c);this._next=this.nodes[0];this._position=0}function w(a){return function(b,c){for(var d,e=c?b:b.parentNode;e;){d=e.nodeType;if(n.arrayContains(a,d))return e;e=e.parentNode}return null}}function t(a,b){if(da(a,b))throw new r("INVALID_NODE_TYPE_ERR");}function y(a){if(!a.startContainer)throw new E("INVALID_STATE_ERR");}function x(a,b){if(!n.arrayContains(b,a.nodeType))throw new r("INVALID_NODE_TYPE_ERR");
}function A(a,b){if(0>b||b>(n.isCharacterDataNode(a)?a.length:a.childNodes.length))throw new E("INDEX_SIZE_ERR");}function D(a,b){if(S(a,!0)!==S(b,!0))throw new E("WRONG_DOCUMENT_ERR");}function v(a){if(ea(a,!0))throw new E("NO_MODIFICATION_ALLOWED_ERR");}function F(a,b){if(!a)throw new E(b);}function z(a){y(a);if(!n.arrayContains(M,a.startContainer.nodeType)&&!S(a.startContainer,!0)||!n.arrayContains(M,a.endContainer.nodeType)&&!S(a.endContainer,!0)||!(a.startOffset<=(n.isCharacterDataNode(a.startContainer)?
a.startContainer.length:a.startContainer.childNodes.length))||!(a.endOffset<=(n.isCharacterDataNode(a.endContainer)?a.endContainer.length:a.endContainer.childNodes.length)))throw Error("Range error: Range is no longer valid after DOM mutation ("+a.inspect()+")");}function L(){}function H(a){a.START_TO_START=U;a.START_TO_END=Y;a.END_TO_END=fa;a.END_TO_START=Z;a.NODE_BEFORE=$;a.NODE_AFTER=aa;a.NODE_BEFORE_AND_AFTER=ba;a.NODE_INSIDE=V}function G(a){H(a);H(a.prototype)}function N(a,b){return function(){z(this);
var c=this.startContainer,d=this.startOffset,e=this.commonAncestorContainer,m=new q(this,!0);c!==e&&(c=n.getClosestAncestorIn(c,e,!0),d=g(c),c=d.node,d=d.offset);l(m,v);m.reset();e=a(m);m.detach();b(this,c,d,c,d);return e}}function P(c,d,e){function l(a,b){return function(c){y(this);x(c,J);x(Q(c),M);c=(a?f:g)(c);(b?h:T)(this,c.node,c.offset)}}function h(a,b,c){var e=a.endContainer,l=a.endOffset;if(b!==a.startContainer||c!==a.startOffset){if(Q(b)!=Q(e)||1==n.comparePoints(b,c,e,l))e=b,l=c;d(a,b,c,
e,l)}}function T(a,b,c){var e=a.startContainer,l=a.startOffset;if(b!==a.endContainer||c!==a.endOffset){if(Q(b)!=Q(e)||-1==n.comparePoints(b,c,e,l))e=b,l=c;d(a,e,l,b,c)}}c.prototype=new L;a.util.extend(c.prototype,{setStart:function(a,b){y(this);t(a,!0);A(a,b);h(this,a,b)},setEnd:function(a,b){y(this);t(a,!0);A(a,b);T(this,a,b)},setStartBefore:l(!0,!0),setStartAfter:l(!1,!0),setEndBefore:l(!0,!1),setEndAfter:l(!1,!1),collapse:function(a){z(this);a?d(this,this.startContainer,this.startOffset,this.startContainer,
this.startOffset):d(this,this.endContainer,this.endOffset,this.endContainer,this.endOffset)},selectNodeContents:function(a){y(this);t(a,!0);d(this,a,0,a,n.getNodeLength(a))},selectNode:function(a){y(this);t(a,!1);x(a,J);var b=f(a);a=g(a);d(this,b.node,b.offset,a.node,a.offset)},extractContents:N(p,d),deleteContents:N(m,d),canSurroundContents:function(){z(this);v(this.startContainer);v(this.endContainer);var a=new q(this,!0),c=a._first&&b(a._first,this)||a._last&&b(a._last,this);a.detach();return!c},
detach:function(){e(this)},splitBoundaries:function(){z(this);var a=this.startContainer,b=this.startOffset,c=this.endContainer,e=this.endOffset,l=a===c;n.isCharacterDataNode(c)&&(0<e&&e<c.length)&&n.splitDataNode(c,e);n.isCharacterDataNode(a)&&(0<b&&b<a.length)&&(a=n.splitDataNode(a,b),l?(e-=b,c=a):c==a.parentNode&&e>=n.getNodeIndex(a)&&e++,b=0);d(this,a,b,c,e)},normalizeBoundaries:function(){z(this);var a=this.startContainer,b=this.startOffset,c=this.endContainer,e=this.endOffset,l=function(a){var b=
a.nextSibling;b&&b.nodeType==a.nodeType&&(c=a,e=a.length,a.appendData(b.data),b.parentNode.removeChild(b))},m=function(d){var l=d.previousSibling;if(l&&l.nodeType==d.nodeType){a=d;var m=d.length;b=l.length;d.insertData(0,l.data);l.parentNode.removeChild(l);a==c?(e+=b,c=a):c==d.parentNode&&(l=n.getNodeIndex(d),e==l?(c=d,e=m):e>l&&e--)}},h=!0;n.isCharacterDataNode(c)?c.length==e&&l(c):(0<e&&(h=c.childNodes[e-1])&&n.isCharacterDataNode(h)&&l(h),h=!this.collapsed);h?n.isCharacterDataNode(a)?0==b&&m(a):
b<a.childNodes.length&&(l=a.childNodes[b])&&n.isCharacterDataNode(l)&&m(l):(a=c,b=e);d(this,a,b,c,e)},collapseToPoint:function(a,b){y(this);t(a,!0);A(a,b);(a!==this.startContainer||b!==this.startOffset||a!==this.endContainer||b!==this.endOffset)&&d(this,a,b,a,b)}});G(c)}function O(a){a.collapsed=a.startContainer===a.endContainer&&a.startOffset===a.endOffset;a.commonAncestorContainer=a.collapsed?a.startContainer:n.getCommonAncestor(a.startContainer,a.endContainer)}function R(a,b,c,d,l){var m=a.startContainer!==
b||a.startOffset!==c,h=a.endContainer!==d||a.endOffset!==l;a.startContainer=b;a.startOffset=c;a.endContainer=d;a.endOffset=l;O(a);e(a,"boundarychange",{startMoved:m,endMoved:h})}function B(a){this.startContainer=a;this.startOffset=0;this.endContainer=a;this.endOffset=0;this._listeners={boundarychange:[],detach:[]};O(this)}a.requireModules(["DomUtil"]);var n=a.dom,I=n.DomPosition,E=a.DOMException;q.prototype={_current:null,_next:null,_first:null,_last:null,isSingleCharacterDataNode:!1,reset:function(){this._current=
...
this.ec?this.eo:a.length,b!=c&&a.deleteData(b,c-b)):a.parentNode&&a.parentNode.removeChild(a)},isPartiallySelectedSubtree:function(){return b(this._current,this.range)},getSubtreeIterator:function(){var a;if(this.isSingleCharacterDataNode)a=this.range.cloneRange(),a.collapse();else{a=new B(d(this.range));var b=this._current,c=b,e=0,l=b,m=n.getNodeLength(b);n.isAncestorOf(b,this.sc,!0)&&(c=this.sc,e=this.so);n.isAncestorOf(b,this.ec,!0)&&(l=this.ec,m=this.eo);R(a,c,e,l,m)}return new q(a,this.clonePartiallySelectedTextNodes)},
...
7,8,10],M=[2,9,11],K=[1,3,4,5,7,8,10,11],T=[1,3,4,5,7,8],Q=n.getRootContainer,S=w([9,11]),ea=w([5,6,10,12]),da=w([6,10,12]),ca=document.createElement("style"),W=!1;try{ca.innerHTML="<b>x</b>",W=3==ca.firstChild.nodeType}catch(ga){}a.features.htmlParsingConforms=W;var X="startContainer startOffset endContainer endOffset collapsed commonAncestorContainer".split(" "),U=0,Y=1,fa=2,Z=3,$=0,aa=1,ba=2,V=3;L.prototype={attachListener:function(a,b){this._listeners[a].push(b)},compareBoundaryPoints:function(a,
b){z(this);D(this.startContainer,b.startContainer);var c=a==Z||a==U?"start":"end",d=a==Y||a==U?"start":"end";return n.comparePoints(this[c+"Container"],this[c+"Offset"],b[d+"Container"],b[d+"Offset"])},insertNode:function(a){z(this);x(a,K);v(this.startContainer);if(n.isAncestorOf(a,this.startContainer,!0))throw new E("HIERARCHY_REQUEST_ERR");a=k(a,this.startContainer,this.startOffset);this.setStartBefore(a)},cloneContents:function(){z(this);var a,b;if(this.collapsed)return d(this).createDocumentFragment();
if(this.startContainer===this.endContainer&&n.isCharacterDataNode(this.startContainer))return a=this.startContainer.cloneNode(!0),a.data=a.data.slice(this.startOffset,this.endOffset),b=d(this).createDocumentFragment(),b.appendChild(a),b;b=new q(this,!0);a=h(b);b.detach();return a},canSurroundContents:function(){z(this);v(this.startContainer);v(this.endContainer);var a=new q(this,!0),c=a._first&&b(a._first,this)||a._last&&b(a._last,this);a.detach();return!c},surroundContents:function(a){x(a,T);if(!this.canSurroundContents())throw new r("BAD_BOUNDARYPOINTS_ERR");
var b=this.extractContents();if(a.hasChildNodes())for(;a.lastChild;)a.removeChild(a.lastChild);k(a,this.startContainer,this.startOffset);a.appendChild(b);this.selectNode(a)},cloneRange:function(){z(this);for(var a=new B(d(this)),b=X.length,c;b--;)c=X[b],a[c]=this[c];return a},toString:function(){z(this);var a=this.startContainer;if(a===this.endContainer&&n.isCharacterDataNode(a))return 3==a.nodeType||4==a.nodeType?a.data.slice(this.startOffset,this.endOffset):"";var b=[],a=new q(this,!0);l(a,function(a){(3==
a.nodeType||4==a.nodeType)&&b.push(a.data)});a.detach();return b.join("")},compareNode:function(a){z(this);var b=a.parentNode,c=n.getNodeIndex(a);if(!b)throw new E("NOT_FOUND_ERR");a=this.comparePoint(b,c);b=this.comparePoint(b,c+1);return 0>a?0<b?ba:$:0<b?aa:V},comparePoint:function(a,b){z(this);F(a,"HIERARCHY_REQUEST_ERR");D(a,this.startContainer);return 0>n.comparePoints(a,b,this.startContainer,this.startOffset)?-1:0<n.comparePoints(a,b,this.endContainer,this.endOffset)?1:0},createContextualFragment:W?
function(a){var b=this.startContainer,c=n.getDocument(b);if(!b)throw new E("INVALID_STATE_ERR");var d=null;1==b.nodeType?d=b:n.isCharacterDataNode(b)&&(d=n.parentElement(b));d=null===d||"HTML"==d.nodeName&&n.isHtmlNamespace(n.getDocument(d).documentElement)&&n.isHtmlNamespace(d)?c.createElement("body"):d.cloneNode(!1);d.innerHTML=a;return n.fragmentFromNodeChildren(d)}:function(a){y(this);var b=d(this).createElement("body");b.innerHTML=a;return n.fragmentFromNodeChildren(b)},toHtml:function(){z(this);
var a=d(this).createElement("div");a.appendChild(this.cloneContents());return a.innerHTML},intersectsNode:function(a,b){z(this);F(a,"NOT_FOUND_ERR");if(n.getDocument(a)!==d(this))return!1;var c=a.parentNode,e=n.getNodeIndex(a);F(c,"NOT_FOUND_ERR");var l=n.comparePoints(c,e,this.endContainer,this.endOffset),c=n.comparePoints(c,e+1,this.startContainer,this.startOffset);return b?0>=l&&0<=c:0>l&&0<c},isPointInRange:function(a,b){z(this);F(a,"HIERARCHY_REQUEST_ERR");D(a,this.startContainer);return 0<=
n.comparePoints(a,b,this.startContainer,this.startOffset)&&0>=n.comparePoints(a,b,this.endContainer,this.endOffset)},intersectsRange:function(a,b){z(this);if(d(a)!=d(this))throw new E("WRONG_DOCUMENT_ERR");var c=n.comparePoints(this.startContainer,this.startOffset,a.endContainer,a.endOffset),e=n.comparePoints(this.endContainer,this.endOffset,a.startContainer,a.startOffset);return b?0>=c&&0<=e:0>c&&0<e},intersection:function(a){if(this.intersectsRange(a)){var b=n.comparePoints(this.startContainer,
...
(b.setStart(c[0],0),a=c.pop(),b.setEnd(a,a.length),a=this.containsRange(b),b.detach(),a):this.containsNodeContents(a)},createNodeIterator:function(a,b){z(this);return new s(this,a,b)},getNodes:function(a,b){z(this);return u(this,a,b)},getDocument:function(){return d(this)},collapseBefore:function(a){y(this);this.setEndBefore(a);this.collapse(!1)},collapseAfter:function(a){y(this);this.setStartAfter(a);this.collapse(!0)},getName:function(){return"DomRange"},equals:function(a){return B.rangesEqual(this,
a)},inspect:function(){return C(this)}};P(B,R,function(a){y(a);a.startContainer=a.startOffset=a.endContainer=a.endOffset=null;a.collapsed=a.commonAncestorContainer=null;e(a,"detach",null);a._listeners=null});a.rangePrototype=L.prototype;B.rangeProperties=X;B.RangeIterator=q;B.copyComparisonConstants=G;B.createPrototypeRange=P;B.inspect=C;B.getRangeDocument=d;B.rangesEqual=function(a,b){return a.startContainer===b.startContainer&&a.startOffset===b.startOffset&&a.endContainer===b.endContainer&&a.endOffset===
b.endOffset};a.DomRange=B;a.RangeException=r});
...
c||(c=a.createNativeRange(r.getDocument(b.startContainer)),c.setEnd(b.endContainer,b.endOffset),c.setStart(b.startContainer,b.startOffset),b._selectionNativeRange=c,b.attachListener("detach",function(){this._selectionNativeRange=null}))):b instanceof t?c=b.nativeRange:a.features.implementsDomRange&&b instanceof r.getWindow(b.startContainer).Range&&(c=b);return c}function k(a){var b=a.getNodes(),c;a:if(!b.length||1!=b[0].nodeType)c=!1;else{c=1;for(var d=b.length;c<d;++c)if(!r.isAncestorOf(b[0],b[c])){c=
!1;break a}c=!0}if(!c)throw Error("getSingleElementFromRange: range "+a.inspect()+" did not consist of a single element");return b[0]}function h(a,b){var c=new t(b);a._ranges=[c];e(a,c,!1);a.rangeCount=1;a.isCollapsed=c.collapsed}function l(b){b._ranges.length=0;if("None"==b.docSelection.type)f(b);else{var c=b.docSelection.createRange();if(c&&"undefined"!=typeof c.text)h(b,c);else{b.rangeCount=c.length;for(var d,l=r.getDocument(c.item(0)),m=0;m<b.rangeCount;++m)d=a.createRange(l),d.selectNode(c.item(m)),
b._ranges.push(d);b.isCollapsed=1==b.rangeCount&&b._ranges[0].collapsed;e(b,b._ranges[b.rangeCount-1],!1)}}}function m(a,b){for(var c=a.docSelection.createRange(),d=k(b),e=r.getDocument(c.item(0)),e=r.getBody(e).createControlRange(),h=0,m=c.length;h<m;++h)e.add(c.item(h));try{e.add(d)}catch(f){throw Error("addRange(): Element within the specified Range could not be added to control selection (does it have layout?)");}e.select();l(a)}function p(a,b,c){this.nativeSelection=a;this.docSelection=b;this._ranges=
[];this.win=c;this.refresh()}function u(a,b){for(var c=r.getDocument(b[0].startContainer),c=r.getBody(c).createControlRange(),d=0,e;d<rangeCount;++d){e=k(b[d]);try{c.add(e)}catch(h){throw Error("setRanges(): Element within the one of the specified Ranges could not be added to control selection (does it have layout?)");}}c.select();l(a)}function C(a,b){if(a.anchorNode&&r.getDocument(a.anchorNode)!==r.getDocument(b))throw new y("WRONG_DOCUMENT_ERR");}function q(a){var b=[],c=new x(a.anchorNode,a.anchorOffset),
d=new x(a.focusNode,a.focusOffset),e="function"==typeof a.getName?a.getName():"Selection";if("undefined"!=typeof a.rangeCount)for(var h=0,l=a.rangeCount;h<l;++h)b[h]=w.inspect(a.getRangeAt(h));return"["+e+"(Ranges: "+b.join(", ")+")(anchor: "+c.inspect()+", focus: "+d.inspect()+"]"}a.requireModules(["DomUtil","DomRange","WrappedRange"]);a.config.checkSelectionRanges=!0;var r=a.dom,s=a.util,w=a.DomRange,t=a.WrappedRange,y=a.DOMException,x=r.DomPosition,A,D,v=a.util.isHostMethod(window,"getSelection"),
F=a.util.isHostObject(document,"selection"),z=F&&(!v||a.config.preferTextRange);z?(A=d,a.isSelectionValid=function(a){a=(a||window).document;var b=a.selection;return"None"!=b.type||r.getDocument(b.createRange().parentElement())==a}):v?(A=b,a.isSelectionValid=function(){return!0}):c.fail("Neither document.selection or window.getSelection() detected.");a.getNativeSelection=A;var v=A(),L=a.createNativeRange(document),H=r.getBody(document),G=s.areHostObjects(v,s.areHostProperties(v,["anchorOffset","focusOffset"]));
a.features.selectionHasAnchorAndFocus=G;var N=s.isHostMethod(v,"extend");a.features.selectionHasExtend=N;var P="number"==typeof v.rangeCount;a.features.selectionHasRangeCount=P;var O=!1,R=!0;s.areHostMethods(v,["addRange","getRangeAt","removeAllRanges"])&&("number"==typeof v.rangeCount&&a.features.implementsDomRange)&&function(){var a=document.createElement("iframe");H.appendChild(a);var b=r.getIframeDocument(a);b.open();b.write("<html><head></head><body>12</body></html>");b.close();var c=r.getIframeWindow(a).getSelection(),
d=b.documentElement.lastChild.firstChild,b=b.createRange();b.setStart(d,1);b.collapse(!0);c.addRange(b);R=1==c.rangeCount;c.removeAllRanges();var e=b.cloneRange();b.setStart(d,0);e.setEnd(d,2);c.addRange(b);c.addRange(e);O=2==c.rangeCount;b.detach();e.detach();H.removeChild(a)}();a.features.selectionSupportsMultipleRanges=O;a.features.collapsedNonEditableSelectionsSupported=R;var B=!1,n;H&&s.isHostMethod(H,"createControlRange")&&(n=H.createControlRange(),s.areHostProperties(n,["item","add"])&&(B=
!0));a.features.implementsControlRange=B;D=G?function(a){return a.anchorNode===a.focusNode&&a.anchorOffset===a.focusOffset}:function(a){return a.rangeCount?a.getRangeAt(a.rangeCount-1).collapsed:!1};var I;s.isHostMethod(v,"getRangeAt")?I=function(a,b){try{return a.getRangeAt(b)}catch(c){return null}}:G&&(I=function(b){var c=r.getDocument(b.anchorNode),c=a.createRange(c);c.setStart(b.anchorNode,b.anchorOffset);c.setEnd(b.focusNode,b.focusOffset);c.collapsed!==this.isCollapsed&&(c.setStart(b.focusNode,
b.focusOffset),c.setEnd(b.anchorNode,b.anchorOffset));return c});a.getSelection=function(a){a=a||window;var b=a._rangySelection,c=A(a),e=F?d(a):null;b?(b.nativeSelection=c,b.docSelection=e,b.refresh(a)):(b=new p(c,e,a),a._rangySelection=b);return b};a.getIframeSelection=function(b){return a.getSelection(r.getIframeWindow(b))};n=p.prototype;if(!z&&G&&s.areHostMethods(v,["removeAllRanges","addRange"])){n.removeAllRanges=function(){this.nativeSelection.removeAllRanges();f(this)};var E=function(b,c){var d=
w.getRangeDocument(c),d=a.createRange(d);d.collapseToPoint(c.endContainer,c.endOffset);b.nativeSelection.addRange(g(d));b.nativeSelection.extend(c.startContainer,c.startOffset);b.refresh()};n.addRange=P?function(b,c){if(B&&F&&"Control"==this.docSelection.type)m(this,b);else if(c&&N)E(this,b);else{var d;O?d=this.rangeCount:(this.removeAllRanges(),d=0);this.nativeSelection.addRange(g(b));this.rangeCount=this.nativeSelection.rangeCount;this.rangeCount==d+1?(a.config.checkSelectionRanges&&(d=I(this.nativeSelection,
this.rangeCount-1))&&!w.rangesEqual(d,b)&&(b=new t(d)),this._ranges[this.rangeCount-1]=b,e(this,b,K(this.nativeSelection)),this.isCollapsed=D(this)):this.refresh()}}:function(a,b){b&&N?E(this,a):(this.nativeSelection.addRange(g(a)),this.refresh())};n.setRanges=function(a){if(B&&1<a.length)u(this,a);else{this.removeAllRanges();for(var b=0,c=a.length;b<c;++b)this.addRange(a[b])}}}else if(s.isHostMethod(v,"empty")&&s.isHostMethod(L,"select")&&B&&z)n.removeAllRanges=function(){try{if(this.docSelection.empty(),
"None"!=this.docSelection.type){var a;if(this.anchorNode)a=r.getDocument(this.anchorNode);else if("Control"==this.docSelection.type){var b=this.docSelection.createRange();b.length&&(a=r.getDocument(b.item(0)).body.createTextRange())}a&&(a.body.createTextRange().select(),this.docSelection.empty())}}catch(c){}f(this)},n.addRange=function(a){"Control"==this.docSelection.type?m(this,a):(t.rangeToTextRange(a).select(),this._ranges[0]=a,this.rangeCount=1,this.isCollapsed=this._ranges[0].collapsed,e(this,
a,!1))},n.setRanges=function(a){this.removeAllRanges();var b=a.length;1<b?u(this,a):b&&this.addRange(a[0])};else return c.fail("No means of selecting a Range or TextRange was found"),!1;n.getRangeAt=function(a){if(0>a||a>=this.rangeCount)throw new y("INDEX_SIZE_ERR");return this._ranges[a]};var J;if(z)J=function(b){var c;a.isSelectionValid(b.win)?c=b.docSelection.createRange():(c=r.getBody(b.win.document).createTextRange(),c.collapse(!0));"Control"==b.docSelection.type?l(b):c&&"undefined"!=typeof c.text?
h(b,c):f(b)};else if(s.isHostMethod(v,"getRangeAt")&&"number"==typeof v.rangeCount)J=function(b){if(B&&F&&"Control"==b.docSelection.type)l(b);else if(b._ranges.length=b.rangeCount=b.nativeSelection.rangeCount,b.rangeCount){for(var c=0,d=b.rangeCount;c<d;++c)b._ranges[c]=new a.WrappedRange(b.nativeSelection.getRangeAt(c));e(b,b._ranges[b.rangeCount-1],K(b.nativeSelection));b.isCollapsed=D(b)}else f(b)};else if(G&&"boolean"==typeof v.isCollapsed&&"boolean"==typeof L.collapsed&&a.features.implementsDomRange)J=
function(a){var b;b=a.nativeSelection;b.anchorNode?(b=I(b,0),a._ranges=[b],a.rangeCount=1,b=a.nativeSelection,a.anchorNode=b.anchorNode,a.anchorOffset=b.anchorOffset,a.focusNode=b.focusNode,a.focusOffset=b.focusOffset,a.isCollapsed=D(a)):f(a)};else return c.fail("No means of obtaining a Range or TextRange from the user's selection was found"),!1;n.refresh=function(a){var b=a?this._ranges.slice(0):null;J(this);if(a){a=b.length;if(a!=this._ranges.length)return!1;for(;a--;)if(!w.rangesEqual(b[a],this._ranges[a]))return!1;
return!0}};var M=function(a,b){var c=a.getAllRanges(),d=!1;a.removeAllRanges();for(var e=0,h=c.length;e<h;++e)d||b!==c[e]?a.addRange(c[e]):d=!0;a.rangeCount||f(a)};n.removeRange=B?function(a){if("Control"==this.docSelection.type){var b=this.docSelection.createRange();a=k(a);for(var c=r.getDocument(b.item(0)),c=r.getBody(c).createControlRange(),d,e=!1,h=0,m=b.length;h<m;++h)d=b.item(h),d!==a||e?c.add(b.item(h)):e=!0;c.select();l(this)}else M(this,a)}:function(a){M(this,a)};var K;!z&&G&&a.features.implementsDomRange?
(K=function(a){var b=!1;a.anchorNode&&(b=1==r.comparePoints(a.anchorNode,a.anchorOffset,a.focusNode,a.focusOffset));return b},n.isBackwards=function(){return K(this)}):K=n.isBackwards=function(){return!1};n.toString=function(){for(var a=[],b=0,c=this.rangeCount;b<c;++b)a[b]=""+this._ranges[b];return a.join("")};n.collapse=function(b,c){C(this,b);var d=a.createRange(r.getDocument(b));d.collapseToPoint(b,c);this.removeAllRanges();this.addRange(d);this.isCollapsed=!0};n.collapseToStart=function(){if(this.rangeCount){var a=
this._ranges[0];this.collapse(a.startContainer,a.startOffset)}else throw new y("INVALID_STATE_ERR");};n.collapseToEnd=function(){if(this.rangeCount){var a=this._ranges[this.rangeCount-1];this.collapse(a.endContainer,a.endOffset)}else throw new y("INVALID_STATE_ERR");};n.selectAllChildren=function(b){C(this,b);var c=a.createRange(r.getDocument(b));c.selectNodeContents(b);this.removeAllRanges();this.addRange(c)};n.deleteFromDocument=function(){if(B&&F&&"Control"==this.docSelection.type){for(var a=this.docSelection.createRange(),
...
w.getRangeDocument(this._ranges[0]).createElement("div"),b=0,c=this._ranges.length;b<c;++b)a.appendChild(this._ranges[b].cloneContents());a=a.innerHTML}return a};n.getName=function(){return"WrappedSelection"};n.inspect=function(){return q(this)};n.detach=function(){this.win=this.anchorNode=this.focusNode=this.win._rangySelection=null};p.inspect=q;a.Selection=p;a.selectionPrototype=n;a.addCreateMissingNativeApiListener(function(b){"undefined"==typeof b.getSelection&&(b.getSelection=function(){return a.getSelection(this)});
...
document)},displaysCaretInEmptyContentEditableCorrectly:function(){return b},hasCurrentStyleProperty:function(){return"currentStyle"in c},hasHistoryIssue:function(){return d},insertsLineBreaksOnReturn:function(){return d},supportsPlaceholderAttributeOn:function(a){return"placeholder"in a},supportsEvent:function(a){var b;if(!(b="on"+a in c))c.setAttribute("on"+a,"return;"),b="function"===typeof c["on"+a];return b},supportsEventsInIframeCorrectly:function(){return!g},supportsHTML5Tags:function(a){a=
...
hasProblemsSettingCaretAfterImg:function(){return b},hasUndoInContextMenu:function(){return d||f||g},hasInsertNodeIssue:function(){return g},hasIframeFocusIssue:function(){return b}}}();
...
(function(a){function c(a){return a.replace(e,function(a,b){var c=(b.match(f)||[])[1]||"",d=k[c];b=b.replace(f,"");b.split(d).length>b.split(c).length&&(b+=c,c="");var e=d=b;b.length>g&&(e=e.substr(0,g)+"...");"www."===d.substr(0,4)&&(d="http://"+d);return'<a href="'+d+'">'+e+"</a>"+c})}function b(h){if(!d.contains(h.nodeName))if(h.nodeType===a.TEXT_NODE&&h.data.match(e)){var l=h.parentNode,m;m=l.ownerDocument;var f=m._wysihtml5_tempElement;f||(f=m._wysihtml5_tempElement=m.createElement("div"));m=
f;m.innerHTML="<span></span>"+c(h.data);for(m.removeChild(m.firstChild);m.firstChild;)l.insertBefore(m.firstChild,h);l.removeChild(h)}else{l=a.lang.array(h.childNodes).get();m=l.length;for(f=0;f<m;f++)b(l[f]);return h}}var d=a.lang.array("CODE PRE A SCRIPT HEAD TITLE STYLE".split(" ")),e=/((https?:\/\/|www\.)[^\s<]{3,})/gi,f=/([^\w\/\-](,?))$/i,g=100,k={")":"(","]":"[","}":"{"};a.dom.autoLink=function(a){var c;a:{c=a;for(var e;c.parentNode;){c=c.parentNode;e=c.nodeName;if(d.contains(e)){c=!0;break a}if("body"===
...
wysihtml5.dom.convertToList=function(){function a(a,b){var d=a.createElement("li");b.appendChild(d);return d}return function(c,b){if("UL"===c.nodeName||"OL"===c.nodeName||"MENU"===c.nodeName)return c;var d=c.ownerDocument,e=d.createElement(b),f=c.querySelectorAll("br"),g=f.length,k,h,l,m,p;for(p=0;p<g;p++)for(k=f[p];(h=k.parentNode)&&h!==c&&h.lastChild===k;){if("block"===wysihtml5.dom.getStyle("display").from(h)){h.removeChild(k);break}wysihtml5.dom.insert(k).after(k.parentNode)}f=wysihtml5.lang.array(c.childNodes).get();
g=f.length;for(p=0;p<g;p++)m=m||a(d,e),k=f[p],h="block"===wysihtml5.dom.getStyle("display").from(k),l="BR"===k.nodeName,h?(m=m.firstChild?a(d,e):m,m.appendChild(k),m=null):l?m=m.firstChild?null:m:m.appendChild(k);0===f.length&&a(d,e);c.parentNode.replaceChild(e,c);return e}}();wysihtml5.dom.copyAttributes=function(a){return{from:function(c){return{to:function(b){for(var d,e=0,f=a.length;e<f;e++)d=a[e],"undefined"!==typeof c[d]&&""!==c[d]&&(b[d]=c[d]);return{andTo:arguments.callee}}}}}};
...
e,d)}}};
wysihtml5.dom.parse=function(){function a(c,e){var h=c.childNodes,l=h.length,f=b[c.nodeType],g=0,k,f=f&&f(c);if(!f)return null;for(g=0;g<l;g++)(k=a(h[g],e))&&f.appendChild(k);return e&&1>=f.childNodes.length&&f.nodeName.toLowerCase()===d&&!f.attributes.length?f.firstChild:f}function c(a,b){b=b.toLowerCase();var c;if(c="IMG"==a.nodeName)if(c="src"==b){var d;a:{try{d=a.complete&&!a.mozMatchesSelector(":-moz-broken");break a}catch(e){if(a.complete&&"complete"===a.readyState){d=!0;break a}}d=void 0}c=
!0===d}return c?a.src:k&&"outerHTML"in a?-1!=a.outerHTML.toLowerCase().indexOf(" "+b+"=")?a.getAttribute(b):null:a.getAttribute(b)}var b={1:function(a){var b,f,k=g.tags;f=a.nodeName.toLowerCase();b=a.scopeName;if(a._wysihtml5)return null;a._wysihtml5=1;if("wysihtml5-temp"===a.className)return null;b&&"HTML"!=b&&(f=b+":"+f);"outerHTML"in a&&!wysihtml5.browser.autoClosesUnclosedTags()&&("P"===a.nodeName&&"</p>"!==a.outerHTML.slice(-4).toLowerCase())&&(f="div");if(f in k){b=k[f];if(!b||b.remove)return null;
b="string"===typeof b?{rename_tag:b}:b}else if(a.firstChild)b={rename_tag:d};else return null;f=a.ownerDocument.createElement(b.rename_tag||f);var k={},q=b.set_class,r=b.add_class,s=b.set_attributes,w=b.check_attributes,t=g.classes,y=0,x=[];b=[];var A=[],D=[],v;s&&(k=wysihtml5.lang.object(s).clone());if(w)for(v in w)if(s=h[w[v]])s=s(c(a,v)),"string"===typeof s&&(k[v]=s);q&&x.push(q);if(r)for(v in r)if(s=l[r[v]])q=s(c(a,v)),"string"===typeof q&&x.push(q);t["_wysihtml5-temp-placeholder"]=1;(D=a.getAttribute("class"))&&
(x=x.concat(D.split(e)));for(r=x.length;y<r;y++)a=x[y],t[a]&&b.push(a);for(t=b.length;t--;)a=b[t],wysihtml5.lang.array(A).contains(a)||A.unshift(a);A.length&&(k["class"]=A.join(" "));for(v in k)try{f.setAttribute(v,k[v])}catch(F){}k.src&&("undefined"!==typeof k.width&&f.setAttribute("width",k.width),"undefined"!==typeof k.height&&f.setAttribute("height",k.height));return f},3:function(a){return a.ownerDocument.createTextNode(a.data)}},d="span",e=/\s+/,f={tags:{},classes:{}},g={},k=!wysihtml5.browser.supportsGetAttributeCorrectly(),
...
"")}}(),numbers:function(){var a=/\D/g;return function(b){return(b=(b||"").replace(a,""))||null}}()},l={align_img:function(){var a={left:"wysiwyg-float-left",right:"wysiwyg-float-right"};return function(b){return a[String(b).toLowerCase()]}}(),align_text:function(){var a={left:"wysiwyg-text-align-left",right:"wysiwyg-text-align-right",center:"wysiwyg-text-align-center",justify:"wysiwyg-text-align-justify"};return function(b){return a[String(b).toLowerCase()]}}(),clear_br:function(){var a={left:"wysiwyg-clear-left",
...
c.charset||"utf-8",stylesheets:this.config.stylesheets});h.open("text/html","replace");h.write(l);h.close();this.getWindow=function(){return f.contentWindow};this.getDocument=function(){return f.contentWindow.document};k.onerror=function(a,b,c){throw Error("wysihtml5.Sandbox: "+a,b,c);};if(!a.browser.supportsSandboxedIframes()){var m,l=0;for(m=b.length;l<m;l++)this._unset(k,b[l]);l=0;for(m=d.length;l<m;l++)this._unset(k,d[l],a.EMPTY_FUNCTION);l=0;for(m=e.length;l<m;l++)this._unset(h,e[l]);this._unset(h,
"cookie","",!0)}this.loaded=!0;setTimeout(function(){g.callback(g)},0)}},_getHtml:function(b){var c=b.stylesheets,d="",e=0,l;if(c="string"===typeof c?[c]:c)for(l=c.length;e<l;e++)d+='<link rel="stylesheet" href="'+c[e]+'">';b.stylesheets=d;return a.lang.string('<!DOCTYPE html><html><head><meta charset="#{charset}">#{stylesheets}</head><body></body></html>').interpolate(b)},_unset:function(b,c,d,e){try{b[c]=d}catch(l){}try{b.__defineGetter__(c,function(){return d})}catch(m){}if(e)try{b.__defineSetter__(c,
function(){})}catch(p){}if(!a.browser.crashesWhenDefineProperty(c))try{var u={get:function(){return d}};e&&(u.set=function(){});Object.defineProperty(b,c,u)}catch(C){}}})})(wysihtml5);(function(){var a={className:"class"};wysihtml5.dom.setAttributes=function(c){return{on:function(b){for(var d in c)b.setAttribute(a[d]||d,c[d])}}}})();
...
wysihtml5.quirks.cleanPastedHTML=function(){var a={"a u":wysihtml5.dom.replaceWithChildNodes};return function(c,b,d){b=b||a;d=d||c.ownerDocument||document;var e="string"===typeof c,f,g,k,h=0;c=e?wysihtml5.dom.getAsDom(c,d):c;for(k in b){f=c.querySelectorAll(k);d=b[k];for(g=f.length;h<g;h++)d(f[h])}return e?c.innerHTML:c}}();
...
!1,k):(k=h.createContextualFragment(k),h.insertNode(k));try{b(h.startContainer,h.endContainer)}catch(m){setTimeout(function(){throw m;},0)}(h=this.doc.querySelector("._wysihtml5-temp-placeholder"))?(k=rangy.createRange(this.doc),l=h.nextSibling,a.browser.hasInsertNodeIssue()&&l&&"BR"===l.nodeName?(l=this.doc.createTextNode(a.INVISIBLE_SPACE),c.insert(l).after(h),k.setStartBefore(l),k.setEndBefore(l)):(k.selectNode(h),k.deleteContents()),this.setSelection(k)):e.focus();d&&(e.scrollTop=f,e.scrollLeft=
g);try{h.parentNode.removeChild(h)}catch(p){}}else b(e,e)},executeAndRestoreSimple:function(a){var c,e,f=this.getRange(),g=this.doc.body,k;if(f){c=f.getNodes([3]);g=c[0]||f.startContainer;k=c[c.length-1]||f.endContainer;c=g===f.startContainer?f.startOffset:0;e=k===f.endContainer?f.endOffset:k.length;try{a(f.startContainer,f.endContainer)}catch(h){setTimeout(function(){throw h;},0)}a=rangy.createRange(this.doc);try{a.setStart(g,c)}catch(l){}try{a.setEnd(k,e)}catch(m){}try{this.setSelection(a)}catch(p){}}else a(g,
...
b.tagName.toLowerCase())&&d)return b;b=b.parentNode}return!1},postApply:function(a,b){for(var c=a[0],d=a[a.length-1],f=[],g,k=c,r=d,s=0,w=d.length,t,y,x=0,A=a.length;x<A;++x)t=a[x],(y=this.getAdjacentMergeableTextNode(t.parentNode,!1))?(g||(g=new e(y),f.push(g)),g.textNodes.push(t),t===c&&(k=g.firstTextNode,s=k.length),t===d&&(r=g.firstTextNode,w=g.getLength())):g=null;if(c=this.getAdjacentMergeableTextNode(d.parentNode,!0))g||(g=new e(d),f.push(g)),g.textNodes.push(c);if(f.length){x=0;for(A=f.length;x<
A;++x)f[x].doMerge();b.setStart(k,s);b.setEnd(r,w)}},getAdjacentMergeableTextNode:function(b,c){var d=b.nodeType==a.TEXT_NODE,e=d?b.parentNode:b,f=c?"nextSibling":"previousSibling";if(d){if((d=b[f])&&d.nodeType==a.TEXT_NODE)return d}else if((d=e[f])&&this.areElementsMergeable(b,d))return d[c?"firstChild":"lastChild"];return null},areElementsMergeable:function(a,b){var d;if(d=c.dom.arrayContains(this.tagNames,(a.tagName||"").toLowerCase()))if(d=c.dom.arrayContains(this.tagNames,(b.tagName||"").toLowerCase()))if(d=
...
a.INVISIBLE_SPACE}catch(g){}b.selectNodeContents(c);f&&d?b.collapse(!1):f&&(b.setStartAfter(c),b.setEndAfter(c))},getTextSelectedByRange:function(a,b){var c=b.cloneRange();c.selectNodeContents(a);var d=c.intersection(b),d=d?d.toString():"";c.detach();return d},isAppliedToRange:function(b){var c=[],d,e=b.getNodes([a.TEXT_NODE]);if(!e.length)return(d=this.getAncestorWithClass(b.startContainer))?[d]:!1;for(var f=0,g=e.length,k;f<g;++f){k=this.getTextSelectedByRange(e[f],b);d=this.getAncestorWithClass(e[f]);
if(""!=k&&!d)return!1;c.push(d)}return c},toggleRange:function(a){this.isAppliedToRange(a)?this.undoToRange(a):this.applyToRange(a)}};a.selection.HTMLApplier=f})(wysihtml5,rangy);
...
(function(a){function c(c,g){var k=c.doc,h="_wysihtml5-temp-"+ +new Date,l=0,m,p,u;a.commands.formatInline.exec(c,b,d,h,/non-matching-class/g);m=k.querySelectorAll(d+"."+h);for(h=m.length;l<h;l++)for(u in p=m[l],p.removeAttribute("class"),g)p.setAttribute(u,g[u]);l=p;1===h&&(u=e.getTextContent(p),h=!!p.querySelector("*"),u=""===u||u===a.INVISIBLE_SPACE,!h&&u&&(e.setTextContent(p,g.text||p.href),k=k.createTextNode(" "),c.selection.setAfter(p),e.insert(k).after(p),l=k));c.selection.setAfter(l)}var b,
...
(function(a){var c=/wysiwyg-font-size-[0-9a-z\-]+/g;a.commands.fontSize={exec:function(b,d,e){return a.commands.formatInline.exec(b,d,"span","wysiwyg-font-size-"+e,c)},state:function(b,d,e){return a.commands.formatInline.state(b,d,"span","wysiwyg-font-size-"+e,c)},value:function(){}}})(wysihtml5);
(function(a){var c=/wysiwyg-font-type-[0-9a-z\-]+/g;a.commands.fontType={exec:function(b,d,e){return a.commands.formatInline.exec(b,d,"span","wysiwyg-font-type-"+e,c)},state:function(b,d,e){return a.commands.formatInline.state(b,d,"span","wysiwyg-font-type-"+e,c)}}})(wysihtml5);
...
l,m,p,u){var C=h.doc,q=this.state(h,l,m,p,u),r=h.config.useLineBreaks,s=r?"DIV":"P",w;m="string"===typeof m?m.toUpperCase():m;if(q)h.selection.executeAndRestoreSimple(function(){u&&(q.className=q.className.replace(u,""));if(!a.lang.string(q.className).trim()&&(r||"P"===m)){var e=q,f=e.ownerDocument,h=b(e),l=c(e);h&&!d(h)&&e.parentNode.insertBefore(f.createElement("br"),h);l&&!d(l)&&e.parentNode.insertBefore(f.createElement("br"),e);g.replaceWithChildNodes(q)}else g.renameElement(q,"P"===m?"DIV":s)});
else{if(null===m||a.lang.array(k).contains(m))if(w=h.selection.getSelectedNode(),q=g.getParentElement(w,{nodeName:k})){h.selection.executeAndRestore(function(){m&&(q=g.renameElement(q,m));if(p){var a=q;a.className?(a.className=a.className.replace(u,""),a.className+=" "+p):a.className=p}});return}h.commands.support(l)?e(C,l,m||s,p):(q=C.createElement(m||s),p&&(q.className=p),f(h,q))}},state:function(a,b,c,d,e){c="string"===typeof c?c.toUpperCase():c;a=a.selection.getSelectedNode();return g.getParentElement(a,
{nodeName:c,className:d,classRegExp:e})}}})(wysihtml5);
(function(a){function c(c,f,g){var k=c+":"+f;if(!d[k]){var h=d,l=a.selection.HTMLApplier,m=b[c];c=m?[c.toLowerCase(),m.toLowerCase()]:[c.toLowerCase()];h[k]=new l(c,f,g,!0)}return d[k]}var b={strong:"b",em:"i",b:"strong",i:"em"},d={};a.commands.formatInline={exec:function(a,b,d,k,h){b=a.selection.getRange();if(!b)return!1;c(d,k,h).toggleRange(b);a.selection.setSelection(b)},state:function(d,f,g,k,h){f=d.doc;var l=b[g]||g;if(!a.dom.hasElementWithTagName(f,g)&&!a.dom.hasElementWithTagName(f,l)||k&&
!a.dom.hasElementWithClassName(f,k))return!1;d=d.selection.getRange();return!d?!1:c(g,k,h).isAppliedToRange(d)}}})(wysihtml5);wysihtml5.commands.insertHTML={exec:function(a,c,b){a.commands.support(c)?a.doc.execCommand(c,!1,b):a.selection.insertHTML(b)},state:function(){return!1}};
(function(a){a.commands.insertImage={exec:function(c,b,d){d="object"===typeof d?d:{src:d};var e=c.doc;b=this.state(c);var f;if(b)c.selection.setBefore(b),d=b.parentNode,d.removeChild(b),a.dom.removeEmptyTextNodes(d),"A"===d.nodeName&&!d.firstChild&&(c.selection.setAfter(d),d.parentNode.removeChild(d)),a.quirks.redraw(c.element);else{b=e.createElement("IMG");for(f in d)"className"===f&&(f="class"),b.setAttribute(f,d[f]);c.selection.insertNode(b);a.browser.hasProblemsSettingCaretAfterImg()?(d=e.createTextNode(a.INVISIBLE_SPACE),
...
wysihtml5.commands.insertOrderedList={exec:function(a,c){var b=a.doc,d=a.selection.getSelectedNode(),e=wysihtml5.dom.getParentElement(d,{nodeName:"OL"}),f=wysihtml5.dom.getParentElement(d,{nodeName:"UL"}),d="_wysihtml5-temp-"+(new Date).getTime(),g;!e&&!f&&a.commands.support(c)?b.execCommand(c,!1,null):e?a.selection.executeAndRestore(function(){wysihtml5.dom.resolveList(e,a.config.useLineBreaks)}):f?a.selection.executeAndRestore(function(){wysihtml5.dom.renameElement(f,"ol")}):(a.commands.exec("formatBlock",
"div",d),g=b.querySelector("."+d),b=""===g.innerHTML||g.innerHTML===wysihtml5.INVISIBLE_SPACE||"<br>"===g.innerHTML,a.selection.executeAndRestore(function(){e=wysihtml5.dom.convertToList(g,"ol")}),b&&a.selection.selectNode(e.querySelector("li"),!0))},state:function(a){a=a.selection.getSelectedNode();return wysihtml5.dom.getParentElement(a,{nodeName:"OL"})}};
wysihtml5.commands.insertUnorderedList={exec:function(a,c){var b=a.doc,d=a.selection.getSelectedNode(),e=wysihtml5.dom.getParentElement(d,{nodeName:"UL"}),f=wysihtml5.dom.getParentElement(d,{nodeName:"OL"}),d="_wysihtml5-temp-"+(new Date).getTime(),g;!e&&!f&&a.commands.support(c)?b.execCommand(c,!1,null):e?a.selection.executeAndRestore(function(){wysihtml5.dom.resolveList(e,a.config.useLineBreaks)}):f?a.selection.executeAndRestore(function(){wysihtml5.dom.renameElement(f,"ul")}):(a.commands.exec("formatBlock",
"div",d),g=b.querySelector("."+d),b=""===g.innerHTML||g.innerHTML===wysihtml5.INVISIBLE_SPACE||"<br>"===g.innerHTML,a.selection.executeAndRestore(function(){e=wysihtml5.dom.convertToList(g,"ul")}),b&&a.selection.selectNode(e.querySelector("li"),!0))},state:function(a){a=a.selection.getSelectedNode();return wysihtml5.dom.getParentElement(a,{nodeName:"UL"})}};
...
this.historyStr[this.position-1],c=this.composer.getValue();if(c!==b){if(25<(this.historyStr.length=this.historyDom.length=this.position))this.historyStr.shift(),this.historyDom.shift(),this.position--;this.position++;var d=this.composer.selection.getRange(),b=d.startContainer||this.element,k=d.startOffset||0,h;b.nodeType===a.ELEMENT_NODE?d=b:(d=b.parentNode,h=this.getChildNodeIndex(d,b));d.setAttribute("data-wysihtml5-selection-offset",k);"undefined"!==typeof h&&d.setAttribute("data-wysihtml5-selection-node",
...
!0):(a.innerHTML="<br>",e.selection.setBefore(a.firstChild))}});c.observe(this.doc,"keydown",function(b){var h=b.keyCode;if(!b.shiftKey&&!(h!==a.ENTER_KEY&&h!==a.BACKSPACE_KEY)){var l=c.getParentElement(e.selection.getSelectedNode(),{nodeName:f},4);l?setTimeout(function(){var b=e.selection.getSelectedNode(),f;if("LI"===l.nodeName){if(!b)return;(f=c.getParentElement(b,{nodeName:g},2))||d(b)}h===a.ENTER_KEY&&l.nodeName.match(/^H[1-6]$/)&&d(b)},0):e.config.useLineBreaks&&(h===a.ENTER_KEY&&!a.browser.insertsLineBreaksOnReturn())&&
(e.commands.exec("insertLineBreak"),b.preventDefault())}})}})})(wysihtml5);
...
["html                 { height: 100%; }","body                 { height: 100%; padding: 1px 0 0 0; margin: -1px 0 0 0; }","body > p:first-child { margin-top: 0; }","._wysihtml5-temp     { display: none; }",a.browser.isGecko?"body.placeholder { color: graytext !important; }":"body.placeholder { color: #a9a9a9 !important; }","img:-moz-broken      { -moz-force-broken-image-icon: 1; height: 24px; width: 24px; }"],h=function(a){if(a.setActive)try{a.setActive()}catch(e){}else{var f=a.style,h=b.documentElement.scrollTop||
b.body.scrollTop,g=b.documentElement.scrollLeft||b.body.scrollLeft,f={position:f.position,top:f.top,left:f.left,WebkitUserSelect:f.WebkitUserSelect};c.setStyles({position:"absolute",top:"-99999px",left:"-99999px",WebkitUserSelect:"none"}).on(a);a.focus();c.setStyles(f).on(a);d.scrollTo&&d.scrollTo(g,h)}};a.views.Composer.prototype.style=function(){var d=this,m=b.querySelector(":focus"),p=this.textarea.element,u=p.hasAttribute("placeholder"),C=u&&p.getAttribute("placeholder"),q=p.style.display,r=p.disabled,
s;this.focusStylesHost=e.cloneNode(!1);this.blurStylesHost=e.cloneNode(!1);this.disabledStylesHost=e.cloneNode(!1);u&&p.removeAttribute("placeholder");p===m&&p.blur();p.disabled=!1;p.style.display=s="none";if(p.getAttribute("rows")&&"auto"===c.getStyle("height").from(p)||p.getAttribute("cols")&&"auto"===c.getStyle("width").from(p))p.style.display=s=q;c.copyStyles(g).from(p).to(this.iframe).andTo(this.blurStylesHost);c.copyStyles(f).from(p).to(this.element).andTo(this.blurStylesHost);c.insertCSS(k).into(this.element.ownerDocument);
p.disabled=!0;c.copyStyles(g).from(p).to(this.disabledStylesHost);c.copyStyles(f).from(p).to(this.disabledStylesHost);p.disabled=r;p.style.display=q;h(p);p.style.display=s;c.copyStyles(g).from(p).to(this.focusStylesHost);c.copyStyles(f).from(p).to(this.focusStylesHost);p.style.display=q;c.copyStyles(["display"]).from(p).to(this.iframe);var w=a.lang.array(g).without(["display"]);m?m.focus():p.blur();u&&p.setAttribute("placeholder",C);this.parent.on("focus:composer",function(){c.copyStyles(w).from(d.focusStylesHost).to(d.iframe);
...
"left","lineboundary"),a.shiftKey||c.collapseToStart()),39===b&&(c.modify("extend","right","lineboundary"),a.shiftKey||c.collapseToEnd()),a.preventDefault()}});c.observe(k,"keydown",function(a){var b=d[a.keyCode];if((a.ctrlKey||a.metaKey)&&!a.altKey&&b)e.commands.exec(b),a.preventDefault()});c.observe(k,"keydown",function(b){var c=e.selection.getSelectedNode(!0),d=b.keyCode;if(c&&"IMG"===c.nodeName&&(d===a.BACKSPACE_KEY||d===a.DELETE_KEY))d=c.parentNode,d.removeChild(c),"A"===d.nodeName&&!d.firstChild&&
d.parentNode.removeChild(d),setTimeout(function(){a.quirks.redraw(k)},0),b.preventDefault()});b.hasIframeFocusIssue()&&(c.observe(this.iframe,"focus",function(){setTimeout(function(){e.doc.querySelector(":focus")!==e.element&&e.focus()},0)}),c.observe(this.element,"blur",function(){setTimeout(function(){e.selection.getSelection().removeAllRanges()},0)}));var m={IMG:"Image: ",A:"Link: "};c.observe(k,"mouseover",function(a){a=a.target;var b=a.nodeName;!("A"!==b&&"IMG"!==b)&&!a.hasAttribute("title")&&
(b=m[b]+(a.getAttribute("href")||a.getAttribute("src")),a.setAttribute("title",b))})}})(wysihtml5);
...
b+"]")).get(),e=c.length,f=0,g=this[b+"Mapping"]={},k,h,l,m,p;f<e;f++)k=c[f],l=k.getAttribute("data-wysihtml5-"+b),m=k.getAttribute("data-wysihtml5-"+b+"-value"),h=this.container.querySelector("[data-wysihtml5-"+b+"-group='"+l+"']"),p=this._getDialog(k,l),g[l+":"+m]={link:k,group:h,name:l,value:m,dialog:p,state:!1}},_getDialog:function(b,c){var e=this,f=this.container.querySelector("[data-wysihtml5-dialog='"+c+"']"),g,k;f&&(g=new a.toolbar.Dialog(b,f),g.on("show",function(){k=e.composer.selection.getBookmark();
...
"mousedown",function(a){a.preventDefault()});c.delegate(e,"[data-wysihtml5-command]","click",function(c){var d=this.getAttribute("data-wysihtml5-command"),e=this.getAttribute("data-wysihtml5-command-value");a.execCommand(d,e);c.preventDefault()});c.delegate(e,"[data-wysihtml5-action]","click",function(c){var d=this.getAttribute("data-wysihtml5-action");a.execAction(d);c.preventDefault()});d.on("focus:composer",function(){a.bookmark=null;clearInterval(a.interval);a.interval=setInterval(function(){a._updateLinkStates()},
500)});d.on("blur:composer",function(){clearInterval(a.interval)});d.on("destroy:composer",function(){clearInterval(a.interval)});d.on("change_view",function(d){setTimeout(function(){a.commandsDisabled="composer"!==d;a._updateLinkStates();a.commandsDisabled?c.addClass(e,"wysihtml5-commands-disabled"):c.removeClass(e,"wysihtml5-commands-disabled")},0)})},_updateLinkStates:function(){var b=this.commandMapping,d=this.actionMapping,e,f,g;for(e in b)g=b[e],this.commandsDisabled?(f=!1,c.removeClass(g.link,
...
_initParser:function(){this.on("paste:composer",function(){var b=this;b.composer.selection.executeAndRestore(function(){a.quirks.cleanPastedHTML(b.composer.element);b.parse(b.composer.element)},!0)})}})})(wysihtml5);
