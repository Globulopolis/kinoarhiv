...
<form action="<?php echo htmlspecialchars(JUri::getInstance()->toString()); ?>" method="post" name="adminForm" id="adminForm" autocomplete="off">
	<div class="btn-group pull-left" style="margin: 0 10px 0 0;">
		<a href="index.php?option=com_kinoarhiv&view=mediamanager&section=name&type=gallery&tab=3&id=<?php echo $this->id; ?>" class="btn <?php echo ($this->tab == 3) ? 'btn-success' : ''; ?>">
			<span class="icon-picture icon-white"></span> <?php echo JText::_('COM_KA_NAMES_GALLERY_PHOTO'); ?>
		</a>
		<a href="index.php?option=com_kinoarhiv&view=mediamanager&section=name&type=gallery&tab=2&id=<?php echo $this->id; ?>" class="btn <?php echo ($this->tab == 2) ? 'btn-success' : ''; ?>">
			<span class="icon-picture icon-white"></span> <?php echo JText::_('COM_KA_NAMES_GALLERY_POSTERS'); ?>
		</a>
		<a href="index.php?option=com_kinoarhiv&view=mediamanager&section=name&type=gallery&tab=1&id=<?php echo $this->id; ?>" class="btn <?php echo ($this->tab == 1) ? 'btn-success' : ''; ?>">
