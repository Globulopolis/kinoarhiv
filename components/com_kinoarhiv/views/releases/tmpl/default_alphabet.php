	...
	<div>
		...
		<span class="ab_letters btn-toolbar">
			<span class="btn-group uk-button-group">
				...
				<a href="<?php echo JRoute::_('index.php?option=com_kinoarhiv&view=releases&letter='.$letters.'&Itemid='.$this->itemid); ?>" class="btn btn-mini btn-default uk-button uk-button-small"><?php echo $letters; ?></a>
				<?php endforeach; ?>
			</span>
		</span>
	</div>
